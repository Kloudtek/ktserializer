 ...
 */
public class TestLibraryAutoLongIdObj extends AbstractCustomSerializable {
    public long val = 8;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TestLibraryAutoLongIdObj)) return false;

        TestLibraryAutoLongIdObj that = (TestLibraryAutoLongIdObj) o;
