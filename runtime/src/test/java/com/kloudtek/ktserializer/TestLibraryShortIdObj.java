 ...
 */
public class TestLibraryShortIdObj extends AbstractCustomSerializable {
    public long val = 8;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TestLibraryShortIdObj)) return false;

        TestLibraryShortIdObj that = (TestLibraryShortIdObj) o;
