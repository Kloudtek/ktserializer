 ...
 */
public class TestLibraryAutoObj extends AbstractCustomSerializable {
    public long val = 8;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TestLibraryAutoObj)) return false;

        TestLibraryAutoObj that = (TestLibraryAutoObj) o;
